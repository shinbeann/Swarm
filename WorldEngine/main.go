...
func (s *server) spawnLandmarks() {
	fixed := []struct {
		...
		{"casualty-5", LandmarkCasualty, 800, 200},
		{"casualty-6", LandmarkCasualty, 650, 400},
		{"casualty-7", LandmarkCasualty, 600, 700},
		{"casualty-8", LandmarkCasualty, 300, 600},
		{"casualty-9", LandmarkCasualty, 200, 900},
		{"casualty-10", LandmarkCasualty, 850, 850},
		{"casualty-11", LandmarkCasualty, 900, 550},
