...
type VerifyCasualtyRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	RobotId       string                 `protobuf:"bytes,1,opt,name=robot_id,json=robotId,proto3" json:"robot_id,omitempty"`
...
func (x *VerifyCasualtyRequest) Reset() {
	*x = VerifyCasualtyRequest{}
	mi := &file_robot_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VerifyCasualtyRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifyCasualtyRequest) ProtoMessage() {}

func (x *VerifyCasualtyRequest) ProtoReflect() protoreflect.Message {
	mi := &file_robot_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VerifyCasualtyRequest.ProtoReflect.Descriptor instead.
func (*VerifyCasualtyRequest) Descriptor() ([]byte, []int) {
	return file_robot_proto_rawDescGZIP(), []int{10}
}

func (x *VerifyCasualtyRequest) GetRobotId() string {
	if x != nil {
		return x.RobotId
	}
	return ""
...
func (x *VerifyCasualtyRequest) GetLandmarkId() string {
	if x != nil {
		return x.LandmarkId
	}
	return ""
...
type VerifyCasualtyResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Success       bool                   `protobuf:"varint,1,opt,name=success,proto3" json:"success,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *VerifyCasualtyResponse) Reset() {
	*x = VerifyCasualtyResponse{}
	mi := &file_robot_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VerifyCasualtyResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VerifyCasualtyResponse) ProtoMessage() {}

func (x *VerifyCasualtyResponse) ProtoReflect() protoreflect.Message {
	mi := &file_robot_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VerifyCasualtyResponse.ProtoReflect.Descriptor instead.
func (*VerifyCasualtyResponse) Descriptor() ([]byte, []int) {
	return file_robot_proto_rawDescGZIP(), []int{11}
}

func (x *VerifyCasualtyResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
const file_robot_proto_rawDesc = "" +
	"\n" +
	"\vrobot.proto\x12\x05swarm\"\x87\x01\n" +
	...
	"\x01x\x18\x02 \x01(\x01R\x01x\x12\f\n" +
	"\x01y\x18\x03 \x01(\x01R\x01y\x12\x18\n" +
	"\aheading\x18\x04 \x01(\x01R\aheading\"S\n" +
	"\x15VerifyCasualtyRequest\x12\x19\n" +
	"\brobot_id\x18\x01 \x01(\tR\arobotId\x12\x1f\n" +
	"\vlandmark_id\x18\x02 \x01(\tR\n" +
	"landmarkId\"2\n" +
	"\x16VerifyCasualtyResponse\x12\x18\n" +
	...
	"\x04term\x18\x01 \x01(\x03R\x04term\x12\x18\n" +
	"\asuccess\x18\x02 \x01(\bR\asuccess2\xdb\x02\n" +
	"\fRobotService\x129\n" +
	...
	"\rSendHeartbeat\x12\x17.swarm.HeartbeatRequest\x1a\x18.swarm.HeartbeatResponse\x12M\n" +
	"\x0eVerifyCasualty\x12\x1c.swarm.VerifyCasualtyRequest\x1a\x1d.swarm.VerifyCasualtyResponse2\x95\x01\n" +
	"\vPeerService\x12;\n" +
...
var file_robot_proto_msgTypes = make([]protoimpl.MessageInfo, 21)
var file_robot_proto_goTypes = []any{
	...
	(*VerifyCasualtyRequest)(nil),  // 10: swarm.VerifyCasualtyRequest
	(*VerifyCasualtyResponse)(nil), // 11: swarm.VerifyCasualtyResponse
	(*PeerSyncRequest)(nil),        // 12: swarm.PeerSyncRequest
	(*PeerSyncResponse)(nil),       // 13: swarm.PeerSyncResponse
	(*RoutedMessageRequest)(nil),   // 14: swarm.RoutedMessageRequest
	(*RoutedMessageResponse)(nil),  // 15: swarm.RoutedMessageResponse
	(*VoteRequest)(nil),            // 16: swarm.VoteRequest
	(*VoteResponse)(nil),           // 17: swarm.VoteResponse
	(*RaftLogEntry)(nil),           // 18: swarm.RaftLogEntry
	(*AppendEntriesRequest)(nil),   // 19: swarm.AppendEntriesRequest
	(*AppendEntriesResponse)(nil),  // 20: swarm.AppendEntriesResponse
}
var file_robot_proto_depIdxs = []int32{
	...
	18, // 2: swarm.AppendEntriesRequest.entries:type_name -> swarm.RaftLogEntry
	...
	10, // 7: swarm.RobotService.VerifyCasualty:input_type -> swarm.VerifyCasualtyRequest
	12, // 8: swarm.PeerService.SyncData:input_type -> swarm.PeerSyncRequest
	14, // 9: swarm.PeerService.RouteMessage:input_type -> swarm.RoutedMessageRequest
	16, // 10: swarm.RaftService.RequestVote:input_type -> swarm.VoteRequest
	19, // 11: swarm.RaftService.AppendEntries:input_type -> swarm.AppendEntriesRequest
	1,  // 12: swarm.RobotService.MoveToPosition:output_type -> swarm.MoveResponse
	4,  // 13: swarm.RobotService.GetSensorData:output_type -> swarm.SensorResponse
	7,  // 14: swarm.RobotService.GetNetworkData:output_type -> swarm.NetworkResponse
	9,  // 15: swarm.RobotService.SendHeartbeat:output_type -> swarm.HeartbeatResponse
	11, // 16: swarm.RobotService.VerifyCasualty:output_type -> swarm.VerifyCasualtyResponse
	13, // 17: swarm.PeerService.SyncData:output_type -> swarm.PeerSyncResponse
	15, // 18: swarm.PeerService.RouteMessage:output_type -> swarm.RoutedMessageResponse
	17, // 19: swarm.RaftService.RequestVote:output_type -> swarm.VoteResponse
	20, // 20: swarm.RaftService.AppendEntries:output_type -> swarm.AppendEntriesResponse
