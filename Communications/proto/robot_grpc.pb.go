...
const (
	...
	RobotService_VerifyCasualty_FullMethodName = "/swarm.RobotService/VerifyCasualty"
)
...
type RobotServiceClient interface {
	...
	// robot informs the world that a casualty has been verified
	VerifyCasualty(ctx context.Context, in *VerifyCasualtyRequest, opts ...grpc.CallOption) (*VerifyCasualtyResponse, error)
}
...
func (c *robotServiceClient) VerifyCasualty(ctx context.Context, in *VerifyCasualtyRequest, opts ...grpc.CallOption) (*VerifyCasualtyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyCasualtyResponse)
	err := c.cc.Invoke(ctx, RobotService_VerifyCasualty_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RobotServiceServer interface {
	...
	// robot informs the world that a casualty has been verified
	VerifyCasualty(context.Context, *VerifyCasualtyRequest) (*VerifyCasualtyResponse, error)
...
func (UnimplementedRobotServiceServer) VerifyCasualty(context.Context, *VerifyCasualtyRequest) (*VerifyCasualtyResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VerifyCasualty not implemented")
}
...
func _RobotService_VerifyCasualty_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyCasualtyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RobotServiceServer).VerifyCasualty(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RobotService_VerifyCasualty_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RobotServiceServer).VerifyCasualty(ctx, req.(*VerifyCasualtyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RobotService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VerifyCasualty",
			Handler:    _RobotService_VerifyCasualty_Handler,
		},
	},
